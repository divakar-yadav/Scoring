...
const jsonData = {
  ...
  "School Percent Proficient ELA {Year}": "School Percent Proficient ELA {Year}",
  "School Percent Proficient Mathematics {Year}": "School Percent Proficient Mathematics {Year}",
  "k1": 0.6,
  "k2": 0.3,
  "k3": 0.2,
};
